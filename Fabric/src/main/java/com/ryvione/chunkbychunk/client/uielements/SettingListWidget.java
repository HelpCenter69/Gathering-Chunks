...
public class SettingListWidget extends ContainerObjectSelectionList<SettingListWidget.SettingEntry> {
    ...
    public SettingListWidget(Minecraft minecraft, Screen parent, int width, int top, int bottom, int rowWidth) {
        super(minecraft, width, parent.height, top, bottom);
    ...
    public class SectionTitleEntry extends SettingEntry {
        ...
        @Override
        public void render(GuiGraphics guiGraphics, int listIndex, int top, int left, int width, int height, int mouseX, int mouseY, boolean hovered, float delta) {
            guiGraphics.drawString(SettingListWidget.this.minecraft.font, this.displayName, left + 12, top + 8, 0xFFFFFF);        }
        @Override
    ...
    public class StringEntry extends AbstractWidgetEntry<EditBox> {
        ...
        public void render(GuiGraphics guiGraphics, int listIndex, int top, int left, int width, int height, int mouseX, int mouseY, boolean hovered, float delta) {
            ...
            guiGraphics.drawString(SettingListWidget.this.minecraft.font, this.displayName, left, top + 6, 0xFFFFFF);
